///! Circuit type enum and metadata.
///!
///! Direct port from gpu_prover/src/circuit_type.rs. This module is
///! GPU-agnostic -- it only defines circuit types and their properties.
